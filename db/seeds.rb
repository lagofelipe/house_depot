...
i1 = Item.create(name: 'French Door Refrigerator in Stainless Steel', price: 1,298) 
i2 = Item.create(name: 'Sinclair Natural Polyester Office Chair', price: 180)
i3 = Item.create(name: 'Accent Cabinet', price: 161)
i4 = Item.create(name: '4-in-1 Select Drive Gas Walk Behind Self Propelled Lawn Mower with Blade Stop System', price: 117)
i5 = Item.create(name: 'Indoor Black Ceiling Fan with Integrated LED with Light Works with Alexa and Remote Control Included', price: 799)
i6 = Item.create(name: 'Faux Wood Blinds', price: 47)
i7 = Item.create(name: 'Protective Enamel Gloss Black Spray Paint', price: 4)
i8 = Item.create(name: 'High Density Knit Fabric Trim Roller with Frame', price: 4)
i9 = Item.create(name: 'Lysol 12.5 oz. Crisp Linen Disinfectant Spray', price: 4)
i10 = Item.create(name: 'Shower Panel System with Waterfall Shower Head and Shower Wand in Black Painted Stainless Steel', price: 349)
i11 = Item.create(name: '4-Burner Propane Gas Grill in Stainless', price: 1249)
i12 = Item.create(name: 'Power Drill', price: 49)
i13 = Item.create(name: 'Gas Snow Blower with Electric Start', price: 999)
i14 = Item.create(name: '10 ft. Inflatable Giant Grinch', price: 159)
i15 = Item.create(name: 'High-Efficiency Platinum Front Load Washing Machine with Steam', price: 678)
i16 = Item.create(name: 'Platinum Electric Dryer with Steam', price: 678)
i17 = Item.create(name: 'Platinum Electric Dryer with Steam', price: 449)
i18 = Item.create(name: '6 oz. Insect Repellent Aerosol Spray', price: 4)
i19 = Item.create(name: 'Acrylic Flatbottom Freestanding Bathtub in White', price: 579)
i20 = Item.create(name: 'Single Flush Elongated Toilet in White, Seat Included', price: 507)
i21 = Item.create(name: 'Wireless Video Doorbell 3 Smart Home Camera Removable Battery Works with Alexa', price: 139)
i22 = Item.create(name: 'Spotlight Cam Wired Outdoor Rectangle Security Camera, Black (2-Pack)', price: 349)
...
Order.create(order_date: "12/25/2019 - 08:30 AM", item_id: i6.id, store_id: s2.id, user_id: u16.id)
Order.create(order_date: "10/11/2019 - 07:15 PM", item_id: i8.id, store_id: s8.id, user_id: u20.id)
Order.create(order_date: "7/24/2018 - 09:33 AM", item_id: i8.id, store_id: s5.id, user_id: u7.id)
Order.create(order_date: "8/16/2017 - 10:46 AM", item_id: i20.id, store_id: s15.id, user_id: u14.id)