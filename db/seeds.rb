...
u14 = User.create(first_name: "Joseph", last_name: "Rosse Exotic", username: 'tigerking2', password: 'TK2')
...
i6 = Item.create(item_name: 'Faux Wood Blinds', price: 47, img_url: 'https://images.homedepot-static.com/productImages/01d093a0-67a1-45c8-a17b-edba65ea1a75/svn/9-colors-available-bali-faux-wood-blinds-37-64_400.jpg')
i7 = Item.create(item_name: 'Protective Enamel Gloss Black Spray Paint', price: 4, img_url: 'https://images.homedepot-static.com/productImages/24fb4deb-51b9-4885-b6e8-f8fd0284c5e1/svn/black-rust-oleum-stops-rust-general-purpose-spray-paint-334128-64_145.jpg')
...
o1 = Order.create(order_date: DateTime.parse("20191011T19:15"), store_id: s8.id, user_id: u20.id)
o2 = Order.create(order_date: DateTime.parse('20180724T09:33'), store_id: s5.id, user_id: u7.id)
o3 = Order.create(order_date: DateTime.parse("20170816T10:46"), store_id: s15.id, user_id: u14.id)
o4 = Order.create(order_date: DateTime.parse("19990108T12:17"), store_id: s9.id, user_id: u1.id)
o5 = Order.create(order_date: DateTime.parse("20200108T15:00"), store_id: s9.id, user_id: u10.id)
