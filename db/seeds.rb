...
o1 = Order.create(order_date: "10/11/2019 - 07:15 PM", item_id: i8.id, store_id: s8.id, user_id: u20.id)
o2 = Order.create(order_date: "7/24/2018 - 09:33 AM", item_id: i8.id, store_id: s5.id, user_id: u7.id)
o3 = Order.create(order_date: "8/16/2017 - 10:46 AM", item_id: i20.id, store_id: s15.id, user_id: u14.id)